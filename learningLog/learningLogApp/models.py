...
class Assunto(models.Model):
    ...
    - data_inicial: Campo de data e hora que armazena automaticamente a data e hora de criação do
    # assunto.
    - owner: Campo de chave estrangeira que associa o assunto a um usuário específico. Isso permite
    que o aplicativo
      identifique quem criou o assunto e implemente a lógica de permissão apropriada.
    - public: Campo booleano que indica se o assunto é público (acessível por todos os usuários) ou
    privado
...
class Entrada(models.Model):
    ...
    STATUS = [("PD", "Pendente"), ("EP", "Em progresso"), ("FT", "Feito")]

    status = models.CharField(max_length=2, choices=STATUS, default="PD")
